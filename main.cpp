...
const char *addr1 = "tcp://192.168.1.103:9060";
void * sock1 = NULL;
char szMsg1[12000] = {0};


const char *addr2 = "tcp://192.168.1.103:9062";
void * sock2 = NULL;
char szMsg2[12000] = {0};

const char *addr3 = "tcp://192.168.1.103:9063";
void * sock3 = NULL;
char szMsg3[12000] = {0};

const char *addr4 = "tcp://192.168.1.103:9065";
void * sock4 = NULL;
char szMsg4[12000] = {0};

const char *addr5 = "tcp://192.168.1.103:9066";
void * sock5 = NULL;
char szMsg5[12000] = {0};

const char *addr6 = "tcp://192.168.1.103:9068";
void * sock6 = NULL;
char szMsg6[12000] = {0};
	...
	void onData(const ObjectListLux* const pObj)
	{
	        ...
	        for (unsigned int i = 0; i < objects.size(); ++i)
		{
		    ...
		    int Vehicle_Speed = objects[i].getRelativeVelocity().getX();
                ...
                //int index = 0;
                //for(index=0;index < lux1.length(); index++){
                //    szMsg1[index] = lux1[index];
                //}
                //szMsg1[index] = '\0';

                //for(index=0;index < lux2.length(); index++){
                //    szMsg2[index] = lux2[index];
                //}
                //szMsg2[index] = '\0';

                //for(index=0;index < lux3.length(); index++){
                //    szMsg3[index] = lux3[index];
                //}
                //szMsg3[index] = '\0';

                //for(index=0;index < lux4.length(); index++){
                //    szMsg4[index] = lux4[index];
                //}
                //szMsg4[index] = '\0';

                //for(index=0;index < lux5.length(); index++){
                //    szMsg5[index] = lux5[index];
                //}
                //szMsg5[index] = '\0';

                //for(index=0;index < lux6.length(); index++){
                //    szMsg6[index] = lux6[index];
                //}
                //szMsg6[index] = '\0';
                ...
                memset(szMsg4,0,sizeof(szMsg4));
                memset(szMsg5,0,sizeof(szMsg5));
                memset(szMsg6,0,sizeof(szMsg6));
